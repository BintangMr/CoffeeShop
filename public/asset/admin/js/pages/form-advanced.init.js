jQuery(document).ready(function () {
    $("#my_multi_select3").multiSelect({
        ...
        afterInit: function (e) {
            var t = this, a = t.$selectableUl.prev(), n = t.$selectionUl.prev(),
...
vspinTrue && $(".vertical-spin").prev(".bootstrap-touchspin-prefix").remove(), $("input[name='demo1']").TouchSpin({
    ...
    minuteStep: 15,
    icons: {up: "mdi mdi-chevron-up", down: "mdi mdi-chevron-down"}
}), $(".colorpicker-default").colorpicker({format: "hex"}), $(".colorpicker-rgba").colorpicker(), jQuery("#datepicker").datepicker(), jQuery("#datepicker-autoclose").datepicker({
    autoclose: !0,
    todayHighlight: !0
    ...
    multidate: !0,
    multidateSeparator: ","
}), jQuery("#date-range").datepicker({toggleActive: !0}), $(".input-daterange-datepicker").daterangepicker({
