<div class="col-12">
    <div class="card-box">
        ...
        <div class="row col-12 mb-2 px-0">
            ...
            @include('admin.product.serbuk.category.create')
        </div>

        <table id="table-serbuk-categories" class="table table-striped table-bordered dt-responsive nowrap">
            <thead>
            <tr>
                <th>#</th>
                <th>Nama</th>
...
@include('admin.product.serbuk.category.show')
@include('admin.product.serbuk.category.edit')
...
@section('js')
    ...
    <script>
        function deleteCategory(id, text = null){
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route('admin.product.serbuk.category.destroy','') }}/'+id,
        ...
        $(document).ready(function () {
            window.table_categories = $('#table-serbuk-categories').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.product.serbuk.category.index') }}",
                order: [[ 1, "asc" ]],
                columns: [
