...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="createBeverageCategory" aria-hidden="true" id="modalAddCategory"
     style="display: none;">
        ...
        $(document).ready(function(){
            ...
            submit.click(function (){
                if (formValid.validate()) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ route('admin.product.beverage.category.store') }}',
                        data: {
                            'nama': inputNama.val(),
                            'status': state
                        },
