<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="createBeverageCategory" aria-hidden="true" id="modalEditCategory"
     style="display: none;">
...
@section('js')
    ...
    <script>
        ...
        function editCategory(id){
            ...
            $.ajax({
                type: 'GET',
                url: '{{ route('admin.product.beverage.category.show','') }}/'+id,
        ...
        $(document).ready(function(){
            ...
            cEditCategory.submit.click(function (){
                if (cEditCategory.formValid.validate()) {
                    ...
                    $.ajax({
                        type: 'PUT',
                        url: '{{ route('admin.product.beverage.category.update','') }}/'+cEditCategory.inputId.val(),
                        data: {
