    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Lihat Artikel </h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form class="row" action="#" id="formShow" data-parsley-validate novalidate>
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="email">Judul Artikel </label>
                            <input class="form-control" type="text" id="inputShowJudul" disabled
                                   placeholder="Nama "
                                   parsley-trigger="change" autocomplete="off">
                        </div>

                        <div class="form-group mb-3">
                            <label for="email">Captiom</label>
                            <textarea class="form-control" type="text" id="inputShowCaption" disabled
                    ...
                    <div class="col-12 row">
                        <div class="col-md-10 col-sm-12">
                            <div class="form-group mb-3">
                                <input type="checkbox" checked disabled data-plugin="switchery" data-color="#00b19d" value="true"
                                       id="inputShowStatus"/>
                            </div>
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        let cShow = {
            ...
            form: $('#formShow'),
            submit: $('#submitShow'),
            inputTitle: $('#inputShowJudul'),
            inputCaption: $('#inputShowCaption'),
        ...
        function showArticle(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    cShow.inputCaption.val(data.data.captiom)
                    cShow.inputDescription.empty().append(data.data.description)
