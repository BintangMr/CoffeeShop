                ...
                <form class="row" action="#" id="formUpdate" data-parsley-validate novalidate>
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" id="inputUpdateUrl" required type="url"
...
@section('js')
    ...
    <script>
        ...
        function editVideo(id) {
            ...
            $.ajax({
                type: 'GET',
                url: '{{ route('admin.gallery.video.show','') }}/' + id,
                success: function (data) {
                    cEdit.inputId.val(data.data.id)
                    cEdit.inputUrl.val(data.data.url)
        ...
        $(document).ready(function () {
            ...
            cEdit.submit.click(function () {
                    if (cEdit.formValid.validate()) {
                        ...
                        fd.append('url', cEdit.inputUrl.val())
                        fd.append('_method', 'PUT')
                        fd.append('id', cEdit.inputId.val())

                        $.ajax({
                            type: 'POST',
                            url: '{{ route('admin.gallery.video.update','') }}/' + cEdit.inputId.val(),
                            contentType: false,
                            processData: false,
                            data: fd,
                            success: function (data) {
