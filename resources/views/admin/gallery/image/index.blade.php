...
@section('title','Liberica Admin | Gallery Image')

@section('title.page','Galleri Image')

@section('page.gallery.image','active')
...
@section('content')
        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <div class="row col-12 mb-2 px-0">
                    <h4 class="mt-0 header-title col-12 col-md-8 mb-2">Gallery Image</h4>
                    @include('admin.gallery.image.create')
                </div>

                <table id="table-gallery-image" class="table table-striped table-bordered dt-responsive nowrap">
                    <thead>
                    <tr>
                        <th>#</th>
                        <th>Gambar</th>
    ...
    @include('admin.gallery.image.show')
    ...
    <script>
        function deletePromo(id, text = null) {
            Swal.fire({
                ...
                text: `Anda akan menghapus gambar galeri ${text} !`,
                icon: 'warning',
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route('admin.gallery.image.destroy','') }}/' + id,
        ...
        $(document).ready(function () {
            window.table_gallery_image = $('#table-gallery-image').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.gallery.image.index') }}",
                order: [[2, "asc"]],
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return `<button class="btn btn-info waves-effect waves-light" onclick="showPromo('${data}')">
                                    ...
                                    <button class="btn btn-danger waves-effect waves-light" onclick="deletePromo('${data}','${row.modified_filename}')">
