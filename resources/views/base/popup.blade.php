    ...
    <div class="sc_menuitems sc_menuitems_style_menuitems-2">
        <div class="sc_menuitems_item">
            <div class="sc_menuitem_image">
                <img class="wp-post-image" width="1920" height="698" alt="" src="{{asset("asset/base/images/3000x2000.png")}}">
{{--                <div class="sc_menuitem_spicy menuitem_spicylevel_5 ">--}}
{{--                    Spicy Level5/5--}}
{{--                </div>--}}
            </div>
            <div class="sc_menuitem_box_title">
                <div class="sc_menuitem_title"><strong>Kopi Bubuk Arabika</strong></div>
                <div class="sc_menuitem_price">Rp. 20.000</div>
                <div class="cL"></div>
            </div>
            <div class="sc_menuitem_content">
                ...
                <a class="prev_menuitem prevnext_menuitem show_popup_menuitem" href="{{ route('menu.popup2') }}">
                    <span class="icon-left"></span>
                </a>
                <a class="next_menuitem prevnext_menuitem show_popup_menuitem" href="{{ route('menu.popup2') }}">
            ...
            <div class="sc_menuitem_more">
                <a class="sc_button sc_button_square sc_button_size_small margin_right_small" href="single-product.html">Whatsapp</a>
                <a class="sc_button sc_button_square sc_button_style_border_2 sc_button_size_small" href="single-post.html#respond">Market Place</a>
                <div class="cL"></div>
            </div>
