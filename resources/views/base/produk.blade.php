...
@push('css')
    ...
    <link rel='stylesheet' href='{{asset("asset/base/js/vendor/prettyPhoto/prettyPhoto.css")}}' type='text/css'
          media='all'/>
    <style>
        .woocommerce #content input.button,.woocommerce #content input.button.alt,.woocommerce #respond input#submit,.woocommerce #respond input#submit.alt,.woocommerce a.button,.woocommerce a.button.alt,.woocommerce button.button,.woocommerce button.button.alt,.woocommerce input.button,.woocommerce input.button.alt,.woocommerce-account .addresses .title .edit,.woocommerce-page #content input.button,.woocommerce-page #content input.button.alt,.woocommerce-page #respond input#submit,.woocommerce-page #respond input#submit.alt,.woocommerce-page a.button,.woocommerce-page a.button.alt,.woocommerce-page button.button,.woocommerce-page button.button.alt,.woocommerce-page input.button,.woocommerce-page input.button.alt{border:2px solid #daa520FF;color:#daa520FF}.woocommerce #content input.button.alt:before,.woocommerce #content input.button:before,.woocommerce #respond input#submit.alt:before,.woocommerce #respond input#submit:before,.woocommerce a.button.alt:before,.woocommerce a.button:before,.woocommerce button.button.alt:before,.woocommerce button.button:before,.woocommerce input.button.alt:before,.woocommerce input.button:before,.woocommerce-account .addresses .title .edit:before,.woocommerce-page #content input.button.alt:before,.woocommerce-page #content input.button:before,.woocommerce-page #respond input#submit.alt:before,.woocommerce-page #respond input#submit:before,.woocommerce-page a.button.alt:before,.woocommerce-page a.button:before,.woocommerce-page button.button.alt:before,.woocommerce-page button.button:before,.woocommerce-page input.button.alt:before,.woocommerce-page input.button:before{border-color:#daa520FF}
    </style>
@endpush
