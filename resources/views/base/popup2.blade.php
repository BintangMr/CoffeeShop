    ...
    <div class="sc_menuitems sc_menuitems_style_menuitems-2">
        <div class="sc_menuitems_item">
            ...
            <div class="sc_menuitem_box_title">
                <div class="sc_menuitem_title"><strong>Kopi Tubruk Bali</strong></div>
            ...
            <div class="sc_menuitem_content">
                ...
                <a class="prev_menuitem prevnext_menuitem show_popup_menuitem" href="{{ route('menu.popup') }}">
                    <span class="icon-left"></span>
                </a>
                <a class="next_menuitem prevnext_menuitem show_popup_menuitem" href="{{ route('menu.popup') }}">
